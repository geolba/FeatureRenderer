...
using System.Windows;//für die MessageBoxes

namespace FeatureRenderer.Core.XmlSerialize
{
    /// <summary>
    ...
    public static class ObjectXMLSerializer<T> where T : class // Specify that T must be a class.
    {
        ...
        private static T LoadFromDocumentFormat(System.Type[] extraTypes, string path, IsolatedStorageFile isolatedStorageFolder)
        {
            ...
            {
                MessageBox.Show("Please define a correct project file for this program!", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
