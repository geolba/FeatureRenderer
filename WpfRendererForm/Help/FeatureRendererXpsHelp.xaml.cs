...
{
    /// <summary>
    /// Interaktionslogik für FeatureRendererXpsHelp.xaml
    /// </summary>
    public partial class FeatureRendererXpsHelp : Page
    {
        XpsDocument doc;
       
        //constructor:
        public FeatureRendererXpsHelp()
        {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //string strDocument = "Help.UserManual.xps";
            string strDocument = "Help.featurerenderer_deutsch.xps";
            ...
            //string strMemoryPackageName = string.Format("memorystream://{0}.xps", "UserManual.xps");
            string strMemoryPackageName = string.Format("memorystream://{0}.xps", "featurerenderer_deutsch.xps");
            ...
            //this.documentViewer1.PageViewsChanged += new EventHandler(documentViewer1_PageViewsChanged);
        }
        ...
        // Move to a page number entered by the user.
